...
def run(game):
    """
       ...
       The function welcomes the player, asks for their name,
       displays the game task,runs the game for a certain number of rounds,
       checks player's answers,and prints the final result.
